...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=aws-1-ap-southeast-1.pooler.supabase.com;Port=5432;Database=postgres;Username=postgres.rkoffuqhgnhzkacarfgi;Password=lmp@123;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Appointment>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.PatientId, e.StaffId }, "IX_Appointments_PatientId_StaffId");
            ...
            entity.HasOne(d => d.Record).WithMany(p => p.Appointments)
        ...
        modelBuilder.Entity<Diagnosis>(entity =>
        {
            ...
            entity.HasOne(d => d.Record).WithMany(p => p.Diagnoses)
                .HasForeignKey(d => d.RecordId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("Diagnoses_RecordId_fkey");

            entity.HasOne(d => d.Staff).WithMany(p => p.Diagnoses)
                .HasForeignKey(d => d.StaffId)
                .OnDelete(DeleteBehavior.SetNull)
        ...
        modelBuilder.Entity<ImportDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Medicine).WithMany(p => p.ImportDetails)
        ...
        modelBuilder.Entity<MedicalStaff>(entity =>
        {
            ...
            entity.HasOne(d => d.Staff).WithOne(p => p.MedicalStaff)
        ...
        modelBuilder.Entity<Queue>(entity =>
        {
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.Queues)
                .HasForeignKey(d => d.AppointmentId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("Queues_AppointmentId_fkey");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.Queues)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("Queues_CreatedBy_fkey");

            entity.HasOne(d => d.Patient).WithMany(p => p.Queues)
                .HasForeignKey(d => d.PatientId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("Queues_PatientId_fkey");

            entity.HasOne(d => d.Record).WithMany(p => p.Queues)
                .HasForeignKey(d => d.RecordId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("Queues_RecordId_fkey");

            entity.HasOne(d => d.Room).WithMany(p => p.Queues)
        ...
        modelBuilder.Entity<ServiceOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.ServiceOrders)
                .HasForeignKey(d => d.AppointmentId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("ServiceOrders_AppointmentId_fkey");

            entity.HasOne(d => d.AssignedStaff).WithMany(p => p.ServiceOrders)
