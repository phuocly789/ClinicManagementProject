    ...
    const fetchData = useCallback(async (start, end) => {
        ...
        try {
            ...
            if (revenueRes.status=='Success') {
                setStats({
                    totalAppointmentsToday: revenueRes.content.totalAppointmentsToday,
                    completedAppointmentsToday: revenueRes.content.completedAppointmentsToday,
                    pendingInvoicesCount: revenueRes.content.pendingInvoicesCount,
                });}
            if (revenueStatisRes.status === 'Success') {
                setTotalRevenue({
                    totalRevenue: revenueStatisRes.content.totalRevenue,
                    byDate: revenueStatisRes.content.byDate,
                });
                console.log(revenueRes);
                console.log(lowStockRes);
                console.log(revenueStatisRes);
